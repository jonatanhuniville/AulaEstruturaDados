...
public class Principal<T extends Comparable<T>> {
    ...
    public void start() throws Exception{
        ...
        for (int i=0; i<vetor10.length; i++) {
            arvore10.adiciona((T) Integer.toString(vetor10[i]));
            pilha.push(vetor10[i]);
        }
        System.out.println("Total de operações na árvore usando um vetor de 10 posições na operação de adição: " + arvore10.contador);
        System.out.println("Total de operações na pilha usando um vetor de 10 posições na operação de adição: " + pilha.contador);
        arvore10.localizar((T) Integer.toString(vetor10[0]));
        System.out.println("Total de operações na árvore usando um vetor de 10 posições na operação de percorrer: " + arvore10.contador);
        pilha.percorrer();
        ...
        arvore10.localizar((T) Integer.toString(vetor20[0]));
        ...
        arvore10.localizar((T) Integer.toString(vetor30[0]));
        ...
        arvore10.localizar((T) Integer.toString(vetor40[0]));
        ...
        arvore10.localizar((T) Integer.toString(vetor50[0]));
        ...
        arvore10.localizar((T) Integer.toString(vetor60[0]));
        ...
        arvore10.localizar((T) Integer.toString(vetor70[0]));
        ...
        arvore10.localizar((T) Integer.toString(vetor80[0]));
        ...
        arvore10.localizar((T) Integer.toString(vetor90[0]));
